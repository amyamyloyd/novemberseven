Scaffolding 2025 Roadmap

# **Boot\_Lang Scaffolding \- Updated Requirements Checklist**
...
* \[ \] **update.sh script**
  ...
  * Updates: .cursorrules, poc\_agent\_prompts.json, docs/, requirements.txt, agent scripts  
...
* \[ \] **Email notifications**: "Boot\_Lang Update Available" with version number, summary of changes, simple update instruction
